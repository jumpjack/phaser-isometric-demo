...
class Example extends Phaser.Scene{
    ...
    preload ()    {
        ...
        this.load.json('map', 'https://raw.githubusercontent.com/jumpjack/melonJS_isometric_example/master/isometric_rpg/data/map/world-002-mod.json');
        this.load.spritesheet('tiles', 'https://raw.githubusercontent.com/jumpjack/melonJS_isometric_example/master/isometric_rpg/data/img/007-color-transp.png', { frameWidth: 24, frameHeight:40 });
        this.load.spritesheet('Player', 'https://raw.githubusercontent.com/jumpjack/melonJS_isometric_example/master/isometric_rpg/data/img/players-mod.png', { frameWidth: 18, frameHeight: 34 });
    }
...
//console.log("Tile for id ", id , "=", tile)                        ;
